...
export default class Login extends Component {
              ...
              if (res.status === 200) {
                  ...
                  for(var i= 0; i < userInfo.length; i++){
                      if(userInfo[i].id === 0){
                        ...
                        cookie.save("lastName",userInfo[i].lsatName);
    ...
    render() {
        ...
        return (
            <div>
                ACCOUNT:<Input placeholder="Account" name="uname" onChange={this.saveAcc}></Input>
                PASSWORD:<Input type="password" name="password" onChange={this.savePwd}></Input>
